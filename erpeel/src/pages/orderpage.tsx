  ...
  >
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
      ...
      <div className="lg:py-24">
        <h2 className="text-3xl font-bold sm:text-4xl">Get Your Own Keyboard NOW!</h2>
    ...
    <div className="w-full h-full flex justify-center items-center bg-[url('/assets/sideshot.jpg')] bg-cover bg-center bg-no-repeat p-8">
